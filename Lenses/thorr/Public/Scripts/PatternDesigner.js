...
// @input bool customRenderOrder
// @input int backgroundOrder = -1 {"showIf":"customRenderOrder"}
// @ui {"widget":"group_end"}
// @ui {"widget":"separator"}
// @input bool useImage
...
function initialize() {
    ...
    var objectHolder = script.getSceneObject().getParent();
    ...
    backgroundImage.setRenderOrder((script.customRenderOrder) ? script.backgroundOrder : thisRenderOrder - 1);
